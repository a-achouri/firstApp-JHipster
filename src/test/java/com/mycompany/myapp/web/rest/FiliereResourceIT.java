...
class FiliereResourceIT {
    ...
    private static final Integer DEFAULT_CODE_FILIERE = 1;
    private static final Integer UPDATED_CODE_FILIERE = 2;

    private static final String DEFAULT_NOM_FILIERE = "AAAAAAAAAA";
    private static final String UPDATED_NOM_FILIERE = "BBBBBBBBBB";

    private static final String DEFAULT_TYPE_FILIERE = "AAAAAAAAAA";
    private static final String UPDATED_TYPE_FILIERE = "BBBBBBBBBB";
    ...
    public static Filiere createEntity(EntityManager em) {
        Filiere filiere = new Filiere().codeFiliere(DEFAULT_CODE_FILIERE).nomFiliere(DEFAULT_NOM_FILIERE).typeFiliere(DEFAULT_TYPE_FILIERE);
        return filiere;
    }
    ...
    public static Filiere createUpdatedEntity(EntityManager em) {
        Filiere filiere = new Filiere().codeFiliere(UPDATED_CODE_FILIERE).nomFiliere(UPDATED_NOM_FILIERE).typeFiliere(UPDATED_TYPE_FILIERE);
        return filiere;
    }
    ...
    void createFiliere() throws Exception {
        ...
        assertThat(testFiliere.getCodeFiliere()).isEqualTo(DEFAULT_CODE_FILIERE);
        assertThat(testFiliere.getNomFiliere()).isEqualTo(DEFAULT_NOM_FILIERE);
        assertThat(testFiliere.getTypeFiliere()).isEqualTo(DEFAULT_TYPE_FILIERE);
    }
    ...
    void getAllFilieres() throws Exception {
        ...
        restFiliereMockMvc
            ...
            .andExpect(jsonPath("$.[*].codeFiliere").value(hasItem(DEFAULT_CODE_FILIERE)))
            .andExpect(jsonPath("$.[*].nomFiliere").value(hasItem(DEFAULT_NOM_FILIERE)))
            .andExpect(jsonPath("$.[*].typeFiliere").value(hasItem(DEFAULT_TYPE_FILIERE)));
    }
    ...
    void getFiliere() throws Exception {
        ...
        restFiliereMockMvc
            ...
            .andExpect(jsonPath("$.codeFiliere").value(DEFAULT_CODE_FILIERE))
            .andExpect(jsonPath("$.nomFiliere").value(DEFAULT_NOM_FILIERE))
            .andExpect(jsonPath("$.typeFiliere").value(DEFAULT_TYPE_FILIERE));
    }
    ...
    void putExistingFiliere() throws Exception {
        ...
        updatedFiliere.codeFiliere(UPDATED_CODE_FILIERE).nomFiliere(UPDATED_NOM_FILIERE).typeFiliere(UPDATED_TYPE_FILIERE);
        ...
        Filiere testFiliere = filiereList.get(filiereList.size() - 1);
        assertThat(testFiliere.getCodeFiliere()).isEqualTo(UPDATED_CODE_FILIERE);
        assertThat(testFiliere.getNomFiliere()).isEqualTo(UPDATED_NOM_FILIERE);
        assertThat(testFiliere.getTypeFiliere()).isEqualTo(UPDATED_TYPE_FILIERE);
    }
    ...
    void partialUpdateFiliereWithPatch() throws Exception {
        ...
        partialUpdatedFiliere.codeFiliere(UPDATED_CODE_FILIERE).nomFiliere(UPDATED_NOM_FILIERE);
    ...
    void fullUpdateFiliereWithPatch() throws Exception {
        ...
        partialUpdatedFiliere.codeFiliere(UPDATED_CODE_FILIERE).nomFiliere(UPDATED_NOM_FILIERE).typeFiliere(UPDATED_TYPE_FILIERE);
